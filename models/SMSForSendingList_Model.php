...
class SMSForSendingList_Model extends ModelSQL{
	...
	public function __construct($dbLink){
		...
		$f_sent_date_time=new FieldSQlDateTimeTZ($this->getDbLink(),$this->getDbName(),$this->getTableName()
		,"sent_date_time"
		,array(
		...
		$f_delivered_date_time=new FieldSQlDateTimeTZ($this->getDbLink(),$this->getDbName(),$this->getTableName()
		,"delivered_date_time"
		,array(
